import { BorderStyle, createElement, Flor, FlorDocument, debug } from '../src'
...
describe('props', () => {
  ...
  it('data should return only plain old objects without artificial values', async done => {
    const div1 = flor.create({border: {type: BorderStyle.round, fg: 'blue'}, focus: {fg: 'yellow', border: {type: BorderStyle.double, fg: 'red'}}, fg: 'green'})
