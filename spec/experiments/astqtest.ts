...
const doc = new Document()
    ...
    {tagName: 'sdf', textContent: 'sdfsd', dummy: 'ajsjsjsjs', 
    children: ['asdasd', {textContent: 'asd', tagName: 'ddd',}, 'asdasdas']}
  ], 
    parent: doc.body,
    dummmm: "asdasd"
  } as any )
...
result .forEach(function (n:any) {
    console.log(isDomElement(n) ?`<${n.tagName}/>` : isDomText(n) ?`'${n.textContent}'` : undefined)
})
