...
export class StylePropsImpl<T extends StyleProps = StyleProps> extends AttrsImpl<Partial<T>> implements Partial<StyleProps> {
  ...
  protected calculatedWidth() {
    ...
    //     if (this._data.width && this._data.width > -1 && this._data.width < 1) {
    //   // if (this.owner._boundsDirty || this._calculatedWidth === 0) {
    //     this._calculatedWidth = isElement(this.owner.parentNode) && Math.round(this.owner.parentNode.contentWidth * (this._data.width||0)) || this._calculatedWidth
    //   // }
    // } else if (this._data.width) {
    //   this._calculatedWidth = this._data.width
    // }
  ...
  protected calculatedHeight() {
    ...
    else if (this._data.height > -1 && this._data.height < 1) {
  ...
  */
  ...
  protected calculatedTop() { 
    ...
    // }
    // else if ((this.owner._positionDirty||this._calculatedTop === 0) && this._data.top > -1 && this._data.top < 1) {
   ...
   else  if(this.owner._positionDirty||this.owner._boundsDirty||this._calculatedTop === 0){
